...
```{r}
#| label: tbl-faosfit
#| tbl-cap: "Summary of regression assessing the effect of region on FAOS-Pain adjusted for confounders."
...
-   The thresholds for VR12-MCS were not derived from foot and ankle populations.
